    ...
    def play(xxx):
        ...
        while dzivibas != 0:
            ...
            #ja nesakrit atņem dzīvību  
                ...
                print(
                    '\033[0;31;40mNepareizs vārds, mini vēlreiz!' 
                    + '\033[0;37;40m'
                    ) 
                dzivibas -= 1     
                        ...
                        if dzivibas == 3: 
                            ...
                            if dzivibas == 2: 
                                ...
                                if dzivibas == 1: 
                                    ...
                                    if win == 1:                                                            
                                            print('\033[0;32;40m Tu atminēji vārdu! Vārds bija: ', 
                                            minamais_vards + "\033[0;37;40m"
                                            )
                                    ...
                                    #vārda neuzminēšanas gadījums kad beigušās dzīvības
                                        ...
                                        print('        ||         ')
                                        print('___†††======†††____')
                                        print('\033[0;31;40m Tu neatminēji vārdu. Vārds bija: ', 
                                        minamais_vards 
                                        + "\033[0;37;40m"
                                        )